...
const CHART_DATA = [
  { name: 'Week 1', approvals: 4, pending: 2 },
  { name: 'Week 2', approvals: 6, pending: 3 },
  { name: 'Week 3', approvals: 5, pending: 1 },
  { name: 'Week 4', approvals: 8, pending: 2 },
];
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">KPI tiles, trend charts, export controls.</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Approvals vs pending over the last 4 weeks.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={CHART_DATA}>
                ...
                <Area type="monotone" dataKey="pending" stroke="rgb(var(--warning))" fill="rgb(var(--warning) / 0.2)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
